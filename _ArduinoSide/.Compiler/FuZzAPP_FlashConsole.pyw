...
class FlashConsole:
    def __init__(self, root):
        self.root = root
        self.root.title("FuZzAPP Flash Console")
        ...
        self.devices = [
            Device(
                device_id='smarttv',
                name='SmartTV R4',
                button_text='Smart TV R4',
                device_type='serial',
                sketch_path=os.path.join(script_dir, '../_FuZzAPP_SmartTV_R4/_FuZzAPP_SmartTV_R4.ino'),
            ...
            Device(
                device_id='diffuser',
                name='Diffuser',
                button_text='Diffuser - WeMos D1 Mini',
                device_type='wifi',
                sketch_path=os.path.join(script_dir, '../_FuZzAPP_Diffuser/_FuZzAPP_Diffuser.ino'),
                ip='192.168.1.203',
                ...
                # command port (see _FuZzAPP_Diffuser.h UDP_PORT). Flashing to
                # 8439 would silently target the wrong listener and fail.
                port=8266,
                telnet_port=23,
