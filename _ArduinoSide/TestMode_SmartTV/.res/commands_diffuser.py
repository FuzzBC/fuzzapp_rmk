...
DIFFUSER_COMMANDS = [
    # ---------------- UDP :8439 ----------------
    {
        ...
        'name': 'Check status', 'label': 'Ds', 'desc': 'Status query -> DsMMSSTTTTUUUUVVVVRRLLLL (mode/strip/parfum/usage/avg/refills)',
        'params': [], 'build': lambda v: 'Ds', 'decode': decode_ds_reply, 'render': {'type': 'status'},
    },
    {
        'id': 'Dc', 'transport': 'udp', 'section': 'UDP :8439',
        'name': 'Poll status (silent)', 'label': 'Dc', 'desc': 'Silent status poll - same reply as Ds, firmware just skips its own verbose log',
        'params': [], 'build': lambda v: 'Dc', 'decode': decode_ds_reply, 'render': {'type': 'status'},
    },
    {
        'id': 'Df', 'transport': 'udp', 'section': 'UDP :8439',
        'name': 'Shut down', 'label': 'Df', 'desc': 'Shutdown (long-press MODE). Refused (LOCKED) while a Parfum window is active',
        'params': [], 'build': lambda v: 'Df',
    },
    {
        'id': 'DpStart', 'transport': 'udp', 'section': 'UDP :8439',
        'name': 'Start parfum timer', 'label': 'Dp start', 'desc': 'DpMMMME - timed insist run, 1-360 min. Always physically runs 10 SEC regardless of E',
        'params': [
    ...
    },
    {
        ...
        'name': 'Cancel parfum timer', 'label': 'Dp0000', 'desc': 'Cancel an active parfum window (no mode digit)',
        'params': [], 'build': lambda v: 'Dp0000',
    },
    {
        'id': 'Dn', 'transport': 'udp', 'section': 'UDP :8439',
        'name': 'Turn on with color', 'label': 'Dn strip-on', 'desc': 'Drive to mode + apply strip colour/effect immediately - DnXXrrggbb[rrggbb]BREESP',
        'params': [
    ...
    # ---------------- Console (Serial + Telnet :23) ----------------
    {
        ...
        'name': 'Force mode directly', 'label': 'M0-M4', 'desc': 'Drive to mode directly. Confirmation is async (real buzzer beep) - re-check with S shortly after',
        'direct_buttons': [('M0', 'M0 OFF'), ('M1', 'M1'), ('M2', 'M2'), ('M3', 'M3'), ('M4', 'M4')],
    },
    {
        'id': 'Parfum', 'transport': 'console', 'section': 'Console (Serial + Telnet :23)',
        'name': 'Set parfum timer (console)', 'label': 'P<min>', 'desc': 'Parfum: decimal minutes 1-360 (note: decimal here, unlike UDP Dp which is hex), 0 = cancel + off',
    ...
    },
    {
        ...
        'name': 'Next strip effect', 'label': 'E', 'desc': 'Cycle to next animated strip effect',
        'params': [], 'build': lambda v: 'E',
    },
    {
        'id': 'ColorTest', 'transport': 'console', 'section': 'Console (Serial + Telnet :23)',
        'name': 'Test solid color', 'label': 'Crrggbb', 'desc': 'Manual solid strip colour test (full brightness, default speed)',
    ...
    },
    {
        ...
        'name': 'Quick status (console)', 'label': 'S', 'desc': 'Quick status (mode / strip)',
        'params': [], 'build': lambda v: 'S',
    },
    {
        'id': 'Debug', 'transport': 'console', 'section': 'Console (Serial + Telnet :23)',
        'name': 'Full debug dump (console)', 'label': 'D', 'desc': 'Full debug dump: mode, strip, buzzer, WiFi, usage/refill history, EEPROM checkpoint',
        'params': [], 'build': lambda v: 'D',
    },
    {
        'id': 'Help', 'transport': 'console', 'section': 'Console (Serial + Telnet :23)',
        'name': 'List console commands', 'label': '?/H', 'desc': 'List console commands',
        'params': [], 'build': lambda v: '?',
    },
    {
        'id': 'Quit', 'transport': 'console', 'section': 'Console (Serial + Telnet :23)',
        'name': 'Close telnet session', 'label': 'Q', 'desc': "Close this telnet session (telnet only - no-op over the tool's per-command reconnect model, but confirms the firmware accepts it)",
